...
def run_training_loop(params):
    ...
    env = gym.make(params['env_name'], render_mode=None, xml_file="half_cheetah_frict.xml")
    env.reset(seed=seed)
    ...
    for itr in range(params['n_iter']):
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          perm_array = np.random.permutation(len(replay_buffer))[:params['train_batch_size']]         
          ob_batch, ac_batch = replay_buffer.obs[perm_array], replay_buffer.acs[perm_array]
