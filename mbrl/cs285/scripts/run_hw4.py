...
def collect_mbpo_rollout(
    ...
    for i in range(rollout_len):
        ...
        next_ob = np.array([mb_agent.get_dynamics_predictions(i, ob, ac) for i in range(mb_agent.ensemble_size)])
    ...
    for itr in range(config["num_iters"]):
        ...
        for _ in tqdm.trange(
            ...
            for i in range(mb_agent.ensemble_size):
                ...
                step_loss = mb_agent.update(i, sample["observations"], sample["actions"], sample["next_observations"])
